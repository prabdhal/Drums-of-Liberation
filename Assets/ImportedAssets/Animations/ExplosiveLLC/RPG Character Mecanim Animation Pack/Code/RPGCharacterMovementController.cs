...
namespace RPGCharacterAnims
{
	public class RPGCharacterMovementController : SuperStateMachine
    {
		...
		/// <summary>
		/// Returns whether the character is close to the ground.
		/// </summary>
		public bool acquiringGround => superCharacterController.currentGround.IsGrounded(false, 0.1f);

		/// <summary>
		/// Returns whether the character is within the specified distance from the ground, while IsGrounded.
		/// </summary>
		public bool maintainingGround => superCharacterController.currentGround.IsGrounded(true, 0.75f);
		...
		/// </summary>
		public float injuredSpeed = 0.3f;
